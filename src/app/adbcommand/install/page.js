...
<div className="flex justify-center gap-4 mt-8">
  ...
  >
    ...
    <p>
      📱 หน้านี้ช่วยให้คุณสามารถอัปโหลดไฟล์ APK และจัดการแอปพลิเคชันที่ติดตั้งในอุปกรณ์ที่เชื่อมต่อผ่าน ADB ได้.<br />
      <strong>ขั้นตอนการทำงาน:</strong><br />
      1. อัปโหลดไฟล์ APK เพื่อดูข้อมูลเช่น <strong>เวอร์ชัน</strong> และ <strong>Package Name</strong>.<br />
      2. ระบบจะเปรียบเทียบข้อมูล APK กับข้อมูลในตารางของอุปกรณ์ที่เชื่อมต่อ.<br />
      3. หากเวอร์ชันและ Package Name ตรงกันจะบอกว่า <strong>เวอร์ชั่นตรงกัน</strong>, ถ้าเวอร์ชันสูงหรือต่ำจะบอกตามสถานการณ์, และถ้าไม่ได้ติดตั้งจะแจ้งว่า <strong>ไม่ได้ติดตั้ง</strong>.<br />
      4. เลือกติดตั้งหรือลบแอปได้ทีละ 1-5 เครื่อง.<br />
      5. คุณสามารถสั่งเปิดแอปที่ติดตั้งอยู่ในอุปกรณ์ได้.<br />
      โปรดระมัดระวังในการเลือกแอปที่ต้องการติดตั้งหรือลบ เพื่อหลีกเลี่ยงผลกระทบต่อการทำงานของอุปกรณ์.
    </p>
  </div>
</div>
